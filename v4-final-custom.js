...
// week 1 variables
 ...
 var week_addon_increment_to_unlimited = 0;
...
// week 2 variables
 ...
 var week2_addon_increment_to_unlimited = 0;
...
$('#node_festival_booking_form_group_fb_wk1_custom').slideUp(200);
$('#node_festival_booking_form_group_fb_wk1_addon').slideUp(200);
...
// check if the value is present --------- end ------------------- week1
...
// =week1 start
 ...
 //check if checked
	 ...
	 $("#edit-field-fb-wk1-ultimate-fun-und-140").prop('disabled', true).prop('checked', false).addClass('display-none'); 
	 $("#edit-field-fb-wk1-ultimate-fun-und-140").prop('disabled', true).addClass('display-none');
	...
	$("#edit-field-fb-wk1-ultimate-fun-und-140").prop('disabled', false).removeClass('display-none'); 
 ...
 // Unlimited  $360 week1 
    $("#edit-field-fb-wk1-unlimited-und-360").click(function() {
	 ...
	 if( $("#edit-field-fb-wk1-unlimited-und-360").is(":checked") ) {
		...
		week1 = 0; 
		week1_addon = 0;
		week_addon_increment_to_unlimited = 0;
...
//week1 ultimate
 ...
 $("#edit-field-fb-wk1-ultimate-fun-und-140").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-flying-trapeze-und-50").prop('disabled', true).prop('checked', false).addClass('display-none'); 

// speciality class
 $("#edit-field-fb-wk1-specialty-classes-und-150-tumbling").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-acrobalance").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-cloudswing").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-mini-tramp").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-jugglingdiablolo").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-static-trapeze").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-chinese-pole").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-handbalance-conditioning").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-unicycle").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-silks").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-teeterboard").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-contortion").prop('disabled', true).prop('checked', false).addClass('display-none'); 
...
//week1 ultimate
	 $("#edit-field-fb-wk1-ultimate-fun-und-140").prop('disabled', false).removeClass('display-none');  
	 $("#edit-field-fb-wk1-flying-trapeze-und-50").prop('disabled', false).removeClass('display-none');  

 
// speciality class
 $("#edit-field-fb-wk1-specialty-classes-und-150-tumbling").prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk1-specialty-classes-und-150-acrobalance").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-cloudswing").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-mini-tramp").prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk1-specialty-classes-und-150-jugglingdiablolo").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-static-trapeze").prop('disabled', false).removeClass('display-none'); ; 
 $("#edit-field-fb-wk1-specialty-classes-und-150-chinese-pole").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-handbalance-conditioning").prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk1-specialty-classes-und-150-unicycle").prop('disabled', true).prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-silks").prop('disabled', true).prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk1-specialty-classes-und-150-teeterboard").prop('disabled', true).prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk1-specialty-classes-und-150-contortion").prop('disabled', true).prop('disabled', false).removeClass('display-none');  


$('#node_festival_booking_form_group_fb_wk1_custom').slideDown();
$('#node_festival_booking_form_group_fb_wk1_addon').slideDown();
...
//  $150 - Tumbling
    $("#edit-field-fb-wk1-specialty-classes-und-150-tumbling").click(function() {
	 ...
	 if( $("#edit-field-fb-wk1-specialty-classes-und-150-tumbling").is(":checked") ) {
		...
		//increment		
		week_addon_increment_to_unlimited++;
		
		if(week_addon_increment_to_unlimited >1) {
		alert("why not book into unlimited program as it’s only an extra $60 and you can join whatever classes you wish");
		}
...
$('#edit-field-fb-wk1-total-und-0-value').val(week1_total);
 ...
 console.log("spl :"+week_addon_increment_to_unlimited);
...
// check if the value is present week2
...
$('#node_festival_booking_form_group_fb_wk2_custom').slideUp(200);
$('#node_festival_booking_form_group_fb_wk2_addon').slideUp(200);
...
// check if the value is present --------- end ------------------- week2
...
// =week2 ----------------Start-------------------
 ...
 // code starts Circus Fun with Captain Fatso $120 - 10am - 11am
    ...
    $("#edit-field-fb-wk2-ultimate-fun-und-140").prop('disabled', true).prop('checked', false).addClass('display-none'); 
    $("#edit-field-fb-wk2-ultimate-fun-und-140").prop('disabled', true).addClass('display-none');
	 ...
	 $("#edit-field-fb-wk2-ultimate-fun-und-140").prop('disabled', false).removeClass('display-none');  
 ...
 // Unlimited  $360 week2 
    $("#edit-field-fb-wk2-unlimited-und-360").click(function() {
	 ...
	 if( $("#edit-field-fb-wk2-unlimited-und-360").is(":checked") ) {
		...
		week2 = 0; 
		week2_addon = 0;
		week2_addon_increment_to_unlimited = 0;
...
//week2 ultimate
 ...
 $("#edit-field-fb-wk2-ultimate-fun-und-140").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-flying-trapeze-und-50").prop('disabled', true).prop('checked', false).addClass('display-none'); 

// speciality class week2
 $("#edit-field-fb-wk2-specialty-classes-und-150-tumbling").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-acrobalance").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-cloudswing").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-mini-tramp").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-jugglingdiablolo").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-static-trapeze").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-chinese-pole").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-handbalance-conditioning").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-unicycle").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-silks").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-teeterboard").prop('disabled', true).prop('checked', false).addClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-contortion").prop('disabled', true).prop('checked', false).addClass('display-none'); 
...
//week2 ultimate
	 $("#edit-field-fb-wk2-ultimate-fun-und-140").prop('disabled', false).removeClass('display-none');  
	 $("#edit-field-fb-wk2-flying-trapeze-und-50").prop('disabled', false).removeClass('display-none');  

 
// speciality class week2
 $("#edit-field-fb-wk2-specialty-classes-und-150-tumbling").prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk2-specialty-classes-und-150-acrobalance").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-cloudswing").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-mini-tramp").prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk2-specialty-classes-und-150-jugglingdiablolo").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-static-trapeze").prop('disabled', false).removeClass('display-none'); ; 
 $("#edit-field-fb-wk2-specialty-classes-und-150-chinese-pole").prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-handbalance-conditioning").prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk2-specialty-classes-und-150-unicycle").prop('disabled', true).prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-silks").prop('disabled', true).prop('disabled', false).removeClass('display-none'); 
 $("#edit-field-fb-wk2-specialty-classes-und-150-teeterboard").prop('disabled', true).prop('disabled', false).removeClass('display-none');  
 $("#edit-field-fb-wk2-specialty-classes-und-150-contortion").prop('disabled', true).prop('disabled', false).removeClass('display-none');  


$('#node_festival_booking_form_group_fb_wk2_custom').slideDown();
$('#node_festival_booking_form_group_fb_wk2_addon').slideDown();
...
//  $150 - Tumbling
    $("#edit-field-fb-wk2-specialty-classes-und-150-tumbling").click(function() {
	 ...
	 if( $("#edit-field-fb-wk2-specialty-classes-und-150-tumbling").is(":checked") ) {
		...
		console.log(week2_addon);week2_total_func();
	 	//increment		
		week2_addon_increment_to_unlimited++;
		
		if(week2_addon_increment_to_unlimited >1) {
		alert("why not book into unlimited program as it’s only an extra $60 and you can join whatever classes you wish");
		}
...
// if state checked place value week3
...
// end if state checked place value week3 end
...
$('#field-fb-phone-numbers-values .field-multiple-drag').remove();
$('#field-fb-email-values .field-multiple-drag').remove();
